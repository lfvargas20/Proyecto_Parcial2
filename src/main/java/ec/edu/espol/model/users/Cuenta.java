...
public class Cuenta implements Serializable{
    ...
    // MÉTODOS
       public static void serializar(ArrayList<Cuenta> array,String archivo){
    ...
    public static ArrayList<Cuenta> leer(String archivo){
    ...
    public static boolean verificarUsuariodisponible(String usuario,String email,String archivo){
        ArrayList<Cuenta> cuen = Cuenta.leer(archivo);
        for(Cuenta c:cuen){
    ...
    public static ArrayList<String> datos(String usuario){
        ArrayList<String> dat = new ArrayList<String>();
        ArrayList<Cuenta> cuen = Cuenta.leer("cuentas");
        for(Cuenta c:cuen){
